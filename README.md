...
- **Tableau de Bord Interactif Streamlit :** L'application `dashboard_kpi.py` fournit une interface utilisateur intuitive pour les professionnels de la santé. Elle charge le modèle sauvegardé et permet :
...
3.  **Exécutez le Tableau de Bord Streamlit :**
    ...
    ```bash
    streamlit run dashboard_kpi.py
    ```
